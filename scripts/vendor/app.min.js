...
$.AdminLTE = {}, $.AdminLTE.options = {
        ...
        colors: {
            lightBlue: "rgba(60,141,188,1.0)",
            red: "rgba(245,105,84,1.0)",
            green: "rgba(0,166,90,1.0)",
            aqua: "rgba(0,192,239,1.0)",
            yellow: "rgba(243,156,18,1.0)",
            blue: "rgba(0,115,183,1.0)",
            ...
            purple: "rgba(142,36,170,1.0)",
            maroon: "rgba(216,27,96,1.0)",
            black: "rgba(34,34,34,1.0)",
            gray: "rgba(210,214,222,1.0)"
        },
        screenSizes: {
            xs: 480,
            sm: 768,
